      ...
      <main className="pt-20">
        <section className="relative overflow-hidden bg-primary py-24 lg:py-32">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-primary-foreground">
            <h1 
              className={cn(
                "text-balance text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-7xl drop-shadow-lg transition-all duration-700",
            ...
            <p 
              className={cn(
                "mx-auto mt-8 max-w-2xl text-pretty text-xl text-primary-foreground/90 lg:text-2xl leading-relaxed transition-all duration-700",
                stage >= 2 ? "hero-animate" : "hero-initial"
              )}
            >
              Tukaj boste našli odgovore na vsa vprašanja o naših storitvih, 
